...
class Users_model extends CI_Model {
    ...
    */
    ...
    /**
    * Fetch sellerbuyers data from the database
    ...
    */
	...
	function getusersname($users_id){
		return $this->db->get_where('users', array('id' => $users_id))->first_row();
	}
