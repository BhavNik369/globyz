    <div class="container top">
      ...
      if(isset($flash_message)){
        if($flash_message == TRUE)
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Well done!</strong> new generic created with success.';
          echo '</div>';       
        }else{
	  ...
	  */
      ...
      echo form_open('admin/generics/add', $attributes);
      ?>
        <fieldset>
         ...
         <!-- <div class="control-group">
          ...
          --><?php
           /* echo '<div class="control-group">';
            echo '<label for="users_id" class="control-label">generics</label>';
         ...
         */ ?>
          <div class="form-actions">
           ...
           <input type="button" onclick="window.location='<?php echo base_url();?>index.php/admin/generics'" value="Cancle">
          </div>
        </fieldset>
